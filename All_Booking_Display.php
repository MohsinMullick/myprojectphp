...
if (isset($_GET['fetch_bookings'])) {
    ...
    // Fetch booking data including Gender
    $sql = "SELECT booking_id, user_name, booking_date, booking_status, destination, gender FROM booking ORDER BY booking_date DESC";
...
<body>
    <div class="section">
        ...
        <table id="bookingTable">
            ...
            <tbody>
                <tr><td colspan="6" class="no-data">Loading bookings...</td></tr>
            </tbody>
        </table>
    </div>
</body>
