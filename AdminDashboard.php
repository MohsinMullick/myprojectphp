...
$sql = "SELECT booking_id, user_name,booking_date,booking_status, destination FROM booking ORDER BY booking_date DESC LIMIT 5";
...
<body>
    <div class="dashboard">
        ...
        <div class="sidebar">
            ...
            <a href="All_Worker_Display_Info.php"><i class="bx bx-user"></i> Workers</a>
            <a href="All_Booking_Display.php"><i class="bx bx-calendar"></i> Bookings</a>
